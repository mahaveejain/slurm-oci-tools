...
"""
rdma_nic_health_snapshot.py does, step by step—it's a quick “RDMA/NIC health snapshotter” 
that parses system state and saves it to a timestamped JSON file.
"""
